...
from trainer import Trainer_multi_task
from . import constants
from .modeling_PHLF import (TransTabClassifier, TransTabFeatureExtractor, TransTabFeatureProcessor,
                            TransTabClassifier_multi_task, TransTabClassifier_multi_task_onlyclss, )
from .modeling_PHLF import TransTabForCL
from .modeling_PHLF import TransTabInputEncoder, TransTabModel
from .dataset import load_data
from .evaluator import predict, evaluate, predict_fun
from .trainer import Trainer, TrainerGradeOnlyClass
...
def build_classifier_multi_task(
        categorical_columns=None,
        numerical_columns=None,
        binary_columns=None,
        feature_extractor=None,
        ...
        checkpoint=None,
        imb_weight=2.0,
        **kwargs) -> TransTabClassifier_multi_task:
    '''Build a :class:`transtab.modeling_transtab.TransTabClassifier`.
    ...
    '''
    model = TransTabClassifier_multi_task(
        categorical_columns=categorical_columns,
        numerical_columns=numerical_columns,
        binary_columns=binary_columns,
        feature_extractor=feature_extractor,
...
def build_classifier_multi_task_onlyclss(
        categorical_columns=None,
        numerical_columns=None,
        binary_columns=None,
        feature_extractor=None,
        ...
        checkpoint=None,
        imb_weight=2.0,
        **kwargs) -> TransTabClassifier_multi_task_onlyclss:

    model = TransTabClassifier_multi_task_onlyclss(
        categorical_columns=categorical_columns,
        numerical_columns=numerical_columns,
        binary_columns=binary_columns,
        feature_extractor=feature_extractor,
...
def train_multi_task_only_class(model,
          trainset,
          valset=None,
          num_epoch=10,
          batch_size=64,
